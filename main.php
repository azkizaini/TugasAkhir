...
<html>
  <head>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="assets/img/data-warehouse.png" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px;margin-right:5px" src="assets/img/data-warehouse-logo.png" alt="Logo"> 
          <span style="font-size:30px">Inventory</span>
        </a>
