...
$query = mysqli_query($mysqli, "SELECT kode_barang,nama_barang,harga_beli,harga_jual,satuan,stok FROM is_barang ORDER BY nama_barang ASC")
...
tr:hover {background-color:#f5f5f5;}
    ...
    <body>
        <div id="title">
            LAPORAN STOK BARANG TOKO SEMBAKO
        </div>
