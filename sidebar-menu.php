	...
	if ($_GET["module"]=="lap_stok") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		...
        		<li><a href="?module=lap_helm_masuk"><i class="fa fa-circle-o"></i> Barang Masuk </a></li>
            <li><a href="?module=lap_helm_keluar"><i class="fa fa-circle-o"></i> Barang Keluar </a></li>
      		</ul>
    	</li>
    <?php
	}
	...
	elseif ($_GET["module"]=="lap_helm_masuk") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		...
        		<li class="active"><a href="?module=lap_helm_masuk"><i class="fa fa-circle-o"></i> Barang Masuk </a></li>
            <li><a href="?module=lap_helm_keluar"><i class="fa fa-circle-o"></i> Barang Keluar </a></li>
      		</ul>
    	</li>
    <?php
	...
	elseif ($_GET["module"]=="lap_helm_keluar") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		<li><a href="?module=lap_stok"><i class="fa fa-circle-o"></i> Stok Barang </a></li>
            <li><a href="?module=lap_helm_masuk"><i class="fa fa-circle-o"></i> Barang Masuk </a></li>
            <li class="active"><a href="?module=lap_helm_keluar"><i class="fa fa-circle-o"></i> Barang Keluar </a></li>
      		</ul>
    	</li>
    <?php
	}
